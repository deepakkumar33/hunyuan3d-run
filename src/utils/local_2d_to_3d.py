...
- Accepts common weight filenames: model.fp16.safetensors, model.fp16.ckpt, model.safetensors,
  model.ckpt, *.ckpt, *.pt, *.pth
    ...
    def _load_pipeline(self):
        ...
        try:
            ...
            for d in candidates:
                ...
                self.logger.debug(f"Checking '{d}': config_exists={os.path.exists(cfg_path)}, weight_file={w}")
