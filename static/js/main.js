document.addEventListener('DOMContentLoaded', function() {
    ...
    // Always use the same origin (including port) that the page was served from
    ...
    try {
        ...
        uploadBtn.addEventListener('click', async () => {
            ...
            try {
                ...
                console.log(`Sending upload request to ${API}/upload_jewelry`);
                ...
                alert(`Error: ${error.message}. Please check the server logs and ensure the server is running.`);
            ...
            exportCards.forEach(card => {
                ...
                btn.addEventListener('click', () => {
                    if (downloadLinks[format]) {
                        window.location.href = `${API}${downloadLinks[format]}`;
                    } else {
